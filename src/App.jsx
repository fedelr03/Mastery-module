...
const DARK = {
  bg: '#0f0f13', surface: '#18181f', border: '#2a2a38', borderLight: '#1e1e2a',
  text: '#e8e8f0', textSecondary: '#a0a0b8', textMuted: '#6a6a82', textFaint: '#3a3a50',
  accent: '#f5a623', accentLight: '#f5a623', accentBg: 'rgba(245,166,35,0.12)',
  red: '#f87171', green: '#4ade80', purple: '#818cf8',
};
...
function TopBar({ session, profile, isAdmin, view, setView, onLogout, dark }) {
  ...
  return (
    <div style={{
      ...
      background: dark ? 'rgba(15,15,19,0.95)' : 'rgba(247,245,240,0.95)',
