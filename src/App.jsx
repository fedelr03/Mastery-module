    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <button onClick={() => setView('module')} style={btnStyle(view === 'module')}>{t.module}</button>
          <button onClick={() => setView('profile')} style={btnStyle(view === 'profile')}>{t.profile}</button>
          {isAdmin && <button onClick={() => setView('admin')} style={btnStyle(view === 'admin')}>{t.dashboard}</button>}
